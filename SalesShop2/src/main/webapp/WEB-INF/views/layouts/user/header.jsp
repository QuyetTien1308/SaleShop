...
<div class="row">
	...
	<p><br> <strong> Hỗ trợ (24/7) :  0326497961 </strong><br><br></p>
		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
				...
				<form action="tim-kiem" method="get"  class="navbar-search pull-left">
				
				<input type="text" placeholder="Bạn muốn tìm gì..." name="nameProduct" class="search-query span2"/>
				
				<input type="submit" name="submitAccount" value="Tìm kiếm" class="shopBtn exclusive">
				</form>
